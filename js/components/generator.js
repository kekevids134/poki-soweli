Vue.component("generator",{
    ...
    template: `<tr>
<td>ilo pali nanpa <layer-colored-text :layerid="generator.layer.layer" v-html="generator.name"></layer-colored-text> <span style="font-size: 70%;">x {{formatNumber(generator.getProductionMulti(), 2, 0)}}</span></td>
